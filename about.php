        ...
        <div class="col-md-6">
        <h2>ABOUT Sky Scholar</h2>
        <p>The <strong>“Sky Scholar”</strong> Website (web based application) is useful for the
...
In this application, student can attend his\her missed classes from e-learn.</p>
        ...
        <p class="footer text-center">Copyright &copy; Sky Scholar 2023  <strong>Cloud Computing</strong> project Made by <strong>VIT AIDS 2023</strong></p>
