                        ...
                        <div class="col-md-4">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td><?php $name = $row['FName'] . " " . $row['LName'];
                                        echo $name; ?></td>
                                </tr>
                            </table>
                        </div>
            ...
            if (isset($_POST['done'])) {
                ...
                if (mysqli_query($connect, $sql)) {
                    ...
                    <div class='alert alert-success fade in' id='success-message'>
                        ...
                        <strong>Success!</strong> Assessment Have Submitted.
                    </div>";
                    echo "<script>disableFormFields();</script>";
                } else {
...
<script>
    function disableFormFields() {
        document.forms["update"]["Q1"].disabled = true;
        document.forms["update"]["Q2"].disabled = true;
        document.forms["update"]["Q3"].disabled = true;
        document.forms["update"]["Q4"].disabled = true;
        document.forms["update"]["Q5"].disabled = true;
    }
</script>
